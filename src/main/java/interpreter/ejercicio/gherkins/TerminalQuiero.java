...
public class TerminalQuiero extends AbstractExpresion {
	...
	public void interpreter(Context context) {
		if (context.lista.get(0).equals("Quiero")) {
			context.output = context.output + " When ";
			context.lista.remove(0);
			while (!context.lista.isEmpty() && !(context.lista.get(0).equals("Como") || context.lista.get(0).equals("Para")
					|| context.lista.get(0).equals("Quiero"))) {
